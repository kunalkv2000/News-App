...
function Science() {
    ...
    useEffect(() => {
        const fetchData = () => {
            fetch("https://newsapi.org/v2/top-headlines?category=science&pagesize=50&language=en&apiKey=01ab4ae4f6e140b09bc457e57e2f5b0a")
                .then(res => res.json())
                .then(data => {
                    if (data.status === "ok") {
            ...
            <div class="mx-auto p-5 sm:p-10 md:p-16">
                <div class="border-b mb-5 flex justify-between text-sm">
                    <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
                        <a href="#" class="font-semibold inline-block">Science News</a>
                    </div>
                </div>
