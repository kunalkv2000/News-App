        ...
        <>
            <footer class="w-full py-14 bg-black">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="max-w-3xl mx-auto items-center justify-center">
                        <a href="https://pagedone.io/" class="flex justify-center ">
                            <img class="mb-6 h-20 w-auto" src="https://raw.githubusercontent.com/kunalkv2000/News-App/refs/heads/main/assets/logo-header.png" alt="Pagedone Logo" />
                        </a>
                        <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                            <li><a href="#" class=" px-2 text-white rounded-lg hover:text-gray-400">Home</a></li>
                            <li><a href="#" class=" px-2 text-white rounded-lg hover:text-gray-400">Contact</a></li>
                            <li><a href="#" class=" px-2 text-white rounded-lg hover:text-gray-400">About</a></li>
                            <li><a href="#" class=" px-2 text-white rounded-lg hover:text-gray-400">Sources</a></li>
                        </ul>
                        ...
                        <span class="text-lg text-white text-center block">©<a href="https://pagedone.io/"> The News Daily</a> 2025, All rights reserved.</span>
                    </div>
                </div>
            </footer>
        </>
